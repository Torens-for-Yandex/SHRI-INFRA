...
(если тест на PR будет просто гореть желтым(не крутиться), то это проблемы с гитхабом. Свяжись со мной, все объясню. Также мб ошибка 404 для тебя или не отображаться содержимое вкладок Issue и PR)
